...
public class PrioridadTicketService implements IPrioridadTicketService {
    ...
    private final IPrioridadTicketRepository prioridadTicketRepository;

    public PrioridadTicketService(
            IPrioridadTicketRepository prioridadTicketRepository) {

        this.prioridadTicketRepository = prioridadTicketRepository;
    }
