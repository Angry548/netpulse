...
public class CategoriaIncidenciaService implements ICategoriaIncidenciaService {
    ...
    private final ICategoriaIncidenciaRepository categoriaIncidenciaRepository;

    public CategoriaIncidenciaService(
            ICategoriaIncidenciaRepository categoriaIncidenciaRepository) {

        this.categoriaIncidenciaRepository =
                categoriaIncidenciaRepository;
    }

    @Override
    public CategoriaIncidencia crear(
    ...
    @Override
    public CategoriaIncidencia buscarPorId(
            Integer id) {
    ...
    @Override
    public CategoriaIncidencia buscarPorNombre(
            String nombre) {
    ...
    @Override
    public CategoriaIncidencia actualizar(
            CategoriaIncidencia categoria) {
    ...
    @Override
    public CategoriaIncidencia activar(
            CategoriaIncidencia categoria) {
    ...
    @Override
    public CategoriaIncidencia desactivar(
            CategoriaIncidencia categoria) {
